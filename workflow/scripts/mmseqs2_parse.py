...
logger = setup_logger("mmseqs2_parse")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Parse MMseqs2 results and join with mapping")
    parser.add_argument("--mmseqs-output", required=True, help="Path to MMseqs2 tabular output file")
