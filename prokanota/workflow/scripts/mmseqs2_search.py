...
def main():
    parser = argparse.ArgumentParser(
        description="MMseqs2 search wrapper (BLAST-like outfmt 6)"
    )
    ...
    parser.add_argument(
        "--sensitivity", type=float, default=None, help="MMseqs2 sensitivity (-s)"
    )
    parser.add_argument(
        "--max-seqs", type=int, default=None, help="Maximum number of target sequences"
    )
    parser.add_argument(
        "--min-seq-id", type=float, default=None, help="Minimum sequence identity (0-1)"
    )
    parser.add_argument(
        "--cov-mode", type=int, default=None, help="Coverage mode (MMseqs2)"
    )
    parser.add_argument(
        "--coverage", type=float, default=None, help="Coverage threshold (0-1)"
    )
