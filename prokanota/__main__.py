...
def cli():
    """flexible pipeline for prokaryotic annotation
    \b
...
\b
RUN EXAMPLES:
Required:           prokanota run --input [file]
Specify threads:    prokanota run ... --threads [threads]
Disable conda:      prokanota run ... --no-use-conda 
